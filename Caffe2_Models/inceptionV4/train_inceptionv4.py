...
def Train_Model(args):
    ...
    base_learning_rate = .045 * total_batch_size

    # weight_decay = (45 * 10**(-3))
    ...
    def create_inception_model_ops(model, loss_scale= 1.0):
        [softmax, loss] = inceptionv4.create_Inceptionv4(model, "data", num_labels, "label")
    ...
    if args.gpu:
        dpm.Parallelize_GPU(
            ...
            forward_pass_builder_fun=create_inception_model_ops,
    ...
    test_model = model_helper.ModelHelper(name="inceptionv4_test", arg_scope=arg_scope, init_params=False)
    ...
    # graph.write_png("Inceptionv4.png")
